...
//     document.write(`<div>`);
//         document.write(`${simpson.name} - ${simpson.surname} - ${simpson.age} - ${simpson.info} <img src="${simpson.photo}" alt="photo">`)
//     document.write(`</div>`);
// }
...
//     document.write(`<img src="${simpson.photo}" alt="photo">`)
//     document.write('</div>')
// }
...
//             document.write(`<h2 class="product-title">${product.title} - ${product.price}</h2>`);
//             document.write(`<img src="${product.image}" alt="photo">`)
//         document.write(`</div>`)
//     document.write(`</div>`)
// }